                                        ...
                                        <div class="elementor-element elementor-element-0641f35 elementor-widget__width-initial elementor-widget elementor-widget-heading"
                                            ...
                                            <div class="elementor-widget-container">
                                                <p class="elementor-heading-title elementor-size-default">
                                                    For the Brand Picsart laminate catalogue title cover, envision a
                                                    sleek black background accented with vibrant neon highlights that
                                                    radiate modernity and style. Utilize a bold, futuristic typography
                                                    to elegantly spell out "We Decorate Your Home with Elegance,"
                                                    ensuring the text stands out and captures attention. Integrate
                                                    subtle neon line designs to frame the text, adding a touch of
                                                    sophistication and visual interest, reflecting the brand's
                                                ...
                                                <div class="elementor-image-carousel-wrapper swiper swiper-initialized swiper-horizontal swiper-pointer-events"
                                                    ...
                                                    <div class="elementor-image-carousel swiper-wrapper" aria-live="off"
                                                        ...
                                                        <div class="swiper-slide swiper-slide-duplicate" role="group"
                                                            aria-roledescription="slide" aria-label="1 / 5"
                                                            data-swiper-slide-index="0" style="width: 390px;"
                                                            aria-hidden="true" inert="">
                                                            <figure class="swiper-slide-inner"><img decoding="async"
                                                                    class="swiper-slide-image"
                                                                    src="./assest/img/portfolio/websitecc/PicsArt/01.jpg "
                                                                    loading="lazy" alt="01"></figure>
                                                        </div>
                                                        <div class="swiper-slide swiper-slide-duplicate" role="group"
                                                            aria-roledescription="slide" aria-label="2 / 5"
                                                            data-swiper-slide-index="1" style="width: 390px;"
                                                            aria-hidden="true" inert="">
                                                            <figure class="swiper-slide-inner"><img decoding="async"
                                                                    class="swiper-slide-image"
                                                                    src="./assest/img/portfolio/websitecc/PicsArt/02.jpg"
                                                                    loading="lazy" alt="04"></figure>
                                                        </div>
                                                        <div class="swiper-slide swiper-slide-duplicate" role="group"
                                                            aria-roledescription="slide" aria-label="3 / 5"
                                                            data-swiper-slide-index="2" style="width: 390px;"
                                                            aria-hidden="true" inert="">
                                                            <figure class="swiper-slide-inner"><img decoding="async"
                                                                    class="swiper-slide-image"
                                                                    src="./assest/img/portfolio/websitecc/PicsArt/03.jpg"
                                                                    loading="lazy" alt="03"></figure>
                                                        </div>
                                                        <div class="swiper-slide swiper-slide-prev" role="group"
                                                            aria-roledescription="slide" aria-label="4 / 5"
                                                            data-swiper-slide-index="3" style="width: 390px;"
                                                            aria-hidden="true" inert="">
                                                            <figure class="swiper-slide-inner"><img decoding="async"
                                                                    class="swiper-slide-image"
                                                                    src="./assest/img/portfolio/websitecc/PicsArt/04.jpg"
                                                                    loading="lazy" alt="05"></figure>
                                                        </div>
                                                        <div class="swiper-slide swiper-slide-active" role="group"
                                                            aria-roledescription="slide" aria-label="5 / 5"
                                                            data-swiper-slide-index="4" style="width: 390px;">
                                                            <figure class="swiper-slide-inner"><img decoding="async"
                                                                    class="swiper-slide-image"
                                                                    src="./assest/img/portfolio/websitecc/PicsArt/05.jpg"
