                                    ...
                                    <div class="elementor-widget-container">
                                        ...
                                        <div class="about-img text-end">
                                            <img decoding="async" class="wow fadeInLeft" data-wow-delay=".5s"
                                                src="./assest/img/service/catalogue-design-company-in-ahmedabad//Laminate-catalouge-design.jpeg"
                                                alt=""
                                                style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInLeft;">

                                            <img decoding="async" class="wow zoomIn" data-wow-delay=".2s"
                                                src="./assest/img/service/catalogue-design-company-in-ahmedabad//Laminate-catalouge-design-mordern.jpeg"
                                                alt=""
