            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="breadcrumb-content-two">
                        <h1 class="title">EcoWood <span> Amaurosis</span></h1>
                    </div>
                </div>
                <div class="col-lg-5">
                  ...
                  <div class="catalog-slider swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img src="https://eembranding.com/assest/img/portfolio/websitecc/Eco-Wood/01.jpg"  loading="lazy" alt="images">
                        </div>
                        <div class="swiper-slide">
                          <img src="https://eembranding.com/assest/img/portfolio/websitecc/Eco-Wood/02.jpg"  loading="lazy" alt="images">
                        </div>
                        <div class="swiper-slide">
                          <img src="https://eembranding.com/assest/img/portfolio/websitecc/Eco-Wood/03.jpg"  loading="lazy" alt="images">
                        </div>
                        <div class="swiper-slide">
                          <img src="https://eembranding.com/assest/img/portfolio/websitecc/Eco-Wood/04.jpg"  loading="lazy" alt="images">
                        </div>
                      </div>
