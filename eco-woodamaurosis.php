                  ...
                  <div class="catalog-slider swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <img src="./assest/img/portfolio/websitecc/Eco-Wood/01.jpg"  loading="lazy" alt="images">
                        </div>
                        <div class="swiper-slide">
                          <img src="./assest/img/portfolio/websitecc/Eco-Wood/02.jpg"  loading="lazy" alt="images">
                        </div>
                        <div class="swiper-slide">
                          <img src="./assest/img/portfolio/websitecc/Eco-Wood/03.jpg"  loading="lazy" alt="images">
                        </div>
                        <div class="swiper-slide">
                          <img src="./assest/img/portfolio/websitecc/Eco-Wood/04.jpg"  loading="lazy" alt="images">
                        </div>
                      </div>
